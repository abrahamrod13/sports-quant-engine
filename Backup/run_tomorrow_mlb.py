from mlb_data_fetcher import (
    get_tomorrow_mlb_games, get_pitcher_stats, get_pitcher_last3,
...
print("=" * 60)
print("⚾ MLB QUANT ENGINE V8 - PREDICCIONES MAÑANA")
print("=" * 60)
...
# ============================================
print("=" * 60)
print(f"📊 PREDICCIONES MLB MAÑANA ({tomorrow.strftime('%d/%m/%Y')})")
print("=" * 60)

if len(all_setups) == 0:
    print("\n🔴 0 SETUPS A+ mañana (Moneyline)")
...
print("=" * 60)
print("✅ Predicciones MLB completadas - V8 |", datetime.now().strftime('%H:%M'))